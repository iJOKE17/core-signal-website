...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            ...
            .laravel-embed__responsive-wrapper { position: relative; height: 0; overflow: hidden; max-width: 100%; width: 100% } 
                                ...
                                <div class="container ps-2"  style="z-index: 2;">
                                    ...
                                    <div class="flex ms-auto align-items-center" >
                                        <div class="nav-item me-5">
                                            <a class="flex align-items-center" href="{{ route('services') }}">
                                                <div class="text-white nav-top-menu">Service</div>
                                            </a>
                                        </div>
                                        <div class="nav-item me-5">
                                            <a class="flex align-items-center" href="{{ route('about-us') }}">
                                                <div class="text-white nav-top-menu">About Us</div>
                                            </a>
                                        </div>
                                        <div class="nav-item me-5">
                                            <a class="flex align-items-center" href="{{ route('support') }}">
